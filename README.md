...
A single-page, browser-based gacha game about reincarnation. Pull the wheel of samsara and find out which country you'd be reborn in — presented as a loot-box rarity system (UR / SSR / SR / R / N) over a real, spinning 3D globe.
...
- **Rarity tiers** — UR (1%), SSR (6%), SR (13%), R (12%), N (68%), each mapped to a pool of real countries.
